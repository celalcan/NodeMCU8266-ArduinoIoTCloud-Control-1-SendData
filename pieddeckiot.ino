...
#define HOST "pieddeck.com/dbwrite.php"          // Enter HOST URL without "http:// "  and "/" at the end of URL
...
http.begin(wclient, "http://pieddeck.com/dbwrite.php");              // Connect to host where MySQL databse is hosted
